...
public class CalcularServlet extends HttpServlet {									//generado por eclipse
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)	//generado por eclipse
		...
		String op2 = request.getParameter("op2"); // para guardar el parámetro utilizo el metodo.getParameter   // numero que introduce el ususario
		...
		request.setAttribute("resultado", resultadoSuma);// suma es parámetro y resultado atributo. suma es el nombre por el que llamare para obtener el valor del atributo
		}
