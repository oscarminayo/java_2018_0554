CREATE DATABASE  IF NOT EXISTS `procedimientos` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `procedimientos`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: procedimientso fgfgfg
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'procedimientso'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `hello`() RETURNS varchar(20) CHARSET utf8
BEGIN	
	RETURN 'Hola Mundo';
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `hello2`() RETURNS varchar(20) CHARSET utf8
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `nombre_mes`( numeroMes INTEGER ) RETURNS varchar(20) CHARSET utf8
BEGIN
...
BEGIN
	DECLARE salida VARCHAR(50) default 'Hola';
...
-- Dump completed on 2019-01-14 14:04:23